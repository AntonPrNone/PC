...
namespace PC_Core
{
    public class PC_Manag // Взаимодействие с данными из БД
    {
        ...
        public void OpenConnection(string connectionString) // Создание подключение
        {
        ...
        public void DeleteTableValues(string pc_name) // Удаление конфигурации
        {
